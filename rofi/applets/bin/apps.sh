...
if [[ "$layout" == 'NO' ]]; then
	...
	option_2=" Terminal <span weight='light' size='small'><i>($term_cmd)</i></span>"
	option_3="󰙯 Discord <span weight='light' size='small'><i>($text_cmd)</i></span>"
	option_4=" Music <span weight='light' size='small'><i>($music_cmd)</i></span>"
	option_5=" Files <span weight='light' size='small'><i>($file_cmd)</i></span>"

...
Config.instname = "University of Applied Sciences Karlsruhe"
Config.profilename = "eduroam"
Config.url = " \
    ""https://www.h-ka.de/en/about-hka/institutions/it-services"
Config.email = "bb.rz@h-ka.de"
Config.title = "eduroam CAT"
Config.server_match = "radius1.hs-karlsruhe.de"
...
Config.user_realm = "h-ka.de"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius1.hs-karlsruhe.de']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@h-ka.de"
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = """• Compliance with the administrative and user regulations as well as the operating regulations of the IT services department is guaranteed (see https://rz.h-ka.de/vbo).

• As a user, I am aware that the information center, as a university-public institution, provides access to the IT infrastructure, which provides content-free access to the Internet.

• The IT services department also stores personal data for operational purposes (billing, error analysis, resource planning and operational security). If violations of the user guidelines or legal provisions are detected, this may result in criminal consequences for the users concerned.
